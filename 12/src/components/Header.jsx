...
export default function Header() {
  ...
  try {
    ...
    getItemsCount = cartStore.getItemsCount;
  } catch (err) {
      ...
      <div className="py-6 px-6">
        <div className="flex flex-col items-center gap-6">
          <Link to="/" className="flex flex-col justify-center items-center gap-2">
            ...
            />
            <p className="text-[#112a55] text-2xl font-bold tracking-wide" style={{ fontFamily: 'Frank Ruhl Libre, serif' }}>
              המקום המושלם לספרי קודש במחירים נוחים
            </p>
          </Link>
